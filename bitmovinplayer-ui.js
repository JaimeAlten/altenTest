  ...
  return (function e(t, n, r) {
  ...
  })(
    {
        ...
        function (require, module, exports) {
          ...
          var BrowserUtils = /** @class */ (function () {
            ...
            Object.defineProperty(BrowserUtils, 'isMobile', {
              ...
              // Mobile detection according to Mozilla recommendation: "In summary, we recommend looking for the string Ã¢â‚¬Å“MobiÃ¢â‚¬Â
          ...
          var AdSkipButton = /** @class */ (function (_super) {
            ...
            AdSkipButton.prototype.configure = function (player, uimanager) {
              ...
              var adStartHandler = function (event) {
                ...
                skippableMessage =
                  (ad.uiConfig && ad.uiConfig.skippableMessage) || config.skippableMessage;
      ...
      12: [
        function (require, module, exports) {
          ...
          var Button = /** @class */ (function (_super) {
            ...
            Button.prototype.toDomElement = function () {
              ...
              var buttonElement = new dom_1.DOM('button', buttonElementAttributes).append(
                new dom_1.DOM('span', {
        ...
        { '../dom': 86, '../eventdispatcher': 88, '../localization/i18n': 93, './component': 18 },
      ],
      13: [
        function (require, module, exports) {
          'use strict';
            ...
            CastStatusOverlay.prototype.configure = function (player, uimanager) {
              ...
              player.on(player.exports.PlayerEvent.CastWaitingForDevice, function (event) {
                ...
                _this.statusLabel.setText(
                  i18n_1.i18n.getLocalizer('connectingTo', { castDeviceName: castDeviceName }),
                );
              });
              player.on(player.exports.PlayerEvent.CastStarted, function (event) {
                ...
                _this.statusLabel.setText(
                  i18n_1.i18n.getLocalizer('playingOn', { castDeviceName: castDeviceName }),
                );
              });
      ...
      18: [
        ...
        { '../dom': 86, '../eventdispatcher': 88, '../guid': 91, '../localization/i18n': 93 },
      ],
      19: [
        function (require, module, exports) {
          'use strict';
        ...
        { '../arrayutils': 1, '../dom': 86, '../localization/i18n': 93, './component': 18 },
      ],
      20: [
        function (require, module, exports) {
          'use strict';
        ...
        function (require, module, exports) {
          ...
          var AdCounter = /** @class */ (function (_super) {
            ...
            AdCounter.prototype.configure = function (player, uimanager) {
              ...
              player.on(player.exports.PlayerEvent.AdBreakStarted, function (event) {
        ...
        function (require, module, exports) {
          ...
          var ControlsOverlay = /** @class */ (function (_super) {
            ...
            function ControlsOverlay(config) {
              ...
              var _this = _super.call(this, config) || this;
              _this.playbackToggleButton = new playbacktogglebutton_1.PlaybackToggleButton();
            ...
            ControlsOverlay.prototype.configure = function (player) {
              ...
              player.on(player.exports.PlayerEvent.SourceLoaded, function () {
                ...
                if (
                  isLive &&
                  (window.location.hash === '' || window.location.hash.indexOf('desplacament') < 0)
                ) {
      ...
      25: [
        function (require, module, exports) {
          ...
          (function (PlaybackTimeLabelMode) {
             ...
             */
            PlaybackTimeLabelMode[(PlaybackTimeLabelMode['CurrentAndTotalTime'] = 2)] =
              'CurrentAndTotalTime';
            /**
            ...
            (PlaybackTimeLabelMode =
              exports.PlaybackTimeLabelMode || (exports.PlaybackTimeLabelMode = {})),
          );
          /**
          ...
          var PlaybackTimeLabel = /** @class */ (function (_super) {
            ...
            PlaybackTimeLabel.prototype.configure = function (player, uimanager) {
              ...
              var liveStreamDetector = new playerutils_1.PlayerUtils.LiveStreamDetector(
                player,
                uimanager,
              );
              ...
              var playbackTimeHandler = function () {
                if (!live && player.getDuration() !== Infinity) {
                  _this.setTime(
                    playerutils_1.PlayerUtils.getCurrentTimeRelativeToSeekableRange(player),
                    player.getDuration(),
                  );
                }
              ...
              var updateTimeFormatBasedOnDuration = function () {
                ...
                _this.timeFormat =
                  Math.abs(player.isLive() ? player.getMaxTimeShift() : player.getDuration()) >=
                    3600
        ...
        function (require, module, exports) {
          ...
          var RecommendationOverlay = /** @class */ (function (_super) {
            ...
            function RecommendationOverlay(config, player) {
              ...
              var labelMosaic = new label_1.Label({ cssClass: 'ui-mosaicetiqueta' });
            ...
            RecommendationItem.prototype.toDomElement = function () {
              ...
              var timeElement = new dom_1.DOM('span', {
                ...
                new dom_1.DOM('span', {
                  ...
                  config.duration ? stringutils_1.StringUtils.secondsToTime(config.duration) : '',
                ),
              );
          ...
          var UpnextItem = /** @class */ (function (_super) {
            ...
            UpnextItem.prototype.configure = function (player, uimanager) {
              ...
              if (this.itemConfig) {
                ...
                player.on(player.exports.PlayerEvent.SourceLoaded, function () {
                  ...
                  resta = duration * (_this.itemConfig.positionPercentatgeOffset / 100);
                });
                player.on(player.exports.PlayerEvent.TimeChanged, function (event) {
                  if (duration === 0) {
                    duration = player.getDuration();
                  }
                  resta = duration * (_this.itemConfig.positionPercentatgeOffset / 100);
                  duration - event.time <= resta && !_this.closed ? _this.show() : _this.hide();
                });
              }
            };
            ...
            UpnextItem.prototype.toDomElement = function () {
              ...
              if (this.itemConfig) {
                ...
                }).css({ 'background-image': 'url('.concat(this.itemConfig.thumbnail, ')') });
                ...
                var timeElement = new dom_1.DOM('span', {
                  ...
                  new dom_1.DOM('span', {
                    ...
                    this.itemConfig.duration
                      ? stringutils_1.StringUtils.secondsToTime(this.itemConfig.duration)
                      : '',
                  ),
                );
            ...
            ErrorMessageOverlay.prototype.configure = function (player, uimanager) {
              ...
              if ((0, mobilev3playerapi_1.isMobileV3PlayerAPI)(player)) {
                var errorEventHandler = function (event) {
                  var message =
                    errorutils_1.ErrorUtils.defaultMobileV3ErrorMessageTranslator(event);
        ...
        function (require, module, exports) {
          ...
          var FullscreenToggleButton = /** @class */ (function (_super) {
            ...
            FullscreenToggleButton.prototype.configure = function (player, uimanager) {
              ...
              uimanager
                .getConfig()
                .events.onUpdated.subscribe(fullscreenAvailabilityChangedHandler);
              this.onClick.subscribe(function () {
      ...
      30: [
        ...
        { '../dom': 86, '../localization/i18n': 93, './playbacktogglebutton': 40 },
      ],
      31: [
        function (require, module, exports) {
          'use strict';
      ...
      34: [
        ...
        { '../arrayutils': 1, '../dom': 86, './listselector': 35, './togglebutton': 76 },
      ],
      35: [
        function (require, module, exports) {
          'use strict';
            ...
            ListSelector.prototype.synchronizeItems = function (newItems) {
              ...
              newItems
                ...
                .forEach(function (item) {
                  return _this.addItem(item.key, item.label, item.sortedInsert, item.ariaLabel);
                });
              this.items
                .filter(function (item) {
                  return (
        ...
        function (require, module, exports) {
          ...
          (function (MetadataLabelContent) {
            ...
            (MetadataLabelContent =
              exports.MetadataLabelContent || (exports.MetadataLabelContent = {})),
          );
          /**
        ...
        function (require, module, exports) {
          ...
          var PictureInPictureToggleButton = /** @class */ (function (_super) {
            ...
            PictureInPictureToggleButton.prototype.configure = function (player, uimanager) {
              ...
              uimanager
                .getConfig()
                .events.onUpdated.subscribe(pictureInPictureAvailabilityChangedHandler);
              this.onClick.subscribe(function () {
      ...
      39: [
        ...
        { '../localization/i18n': 93, '../playerutils': 99, '../stringutils': 112, './label': 33 },
      ],
      40: [
        function (require, module, exports) {
          'use strict';
           ...
           */
          var PlaybackToggleButton = (exports.PlaybackToggleButton = /** @class */ (function (
            _super,
          ) {
            ...
            PlaybackToggleButton.prototype.configure = function (
              ...
              var updateLiveState = function () {
                var showStopToggle =
                  player.isLive() && !playerutils_1.PlayerUtils.isTimeShiftAvailable(player);
                if (showStopToggle) {
                  _this
                    .getDomElement()
                    .addClass(_this.prefixCss(PlaybackToggleButton.CLASS_STOPTOGGLE));
                } else {
                  _this
                    .getDomElement()
                    .removeClass(_this.prefixCss(PlaybackToggleButton.CLASS_STOPTOGGLE));
                }
              };
              // Detect absence of timeshifting on live streams and add tagging class to convert button icons to play/stop
              var timeShiftDetector = new playerutils_1.PlayerUtils.TimeShiftAvailabilityDetector(
                player,
              );
              var liveStreamDetector = new playerutils_1.PlayerUtils.LiveStreamDetector(
                player,
              ...
              timeShiftDetector.onTimeShiftAvailabilityChanged.subscribe(function () {
        ...
        { '../localization/i18n': 93, '../playerutils': 99, './togglebutton': 76 },
      ],
      41: [
        function (require, module, exports) {
          'use strict';
        ...
        function (require, module, exports) {
          ...
          var SeekBar = (exports.SeekBar = /** @class */ (function (_super) {
            ...
            function SeekBar(config) {
              ...
              _this.getTargetSeekPosition = function (percentage) {
                ...
                if (_this.player.isLive()) {
                  ...
                  var seekableRangeStart = playerutils_1.PlayerUtils.getSeekableRangeStart(
                    _this.player,
                    0,
                  );
              ...
              if (this.seekBarType === seekbarcontroller_1.SeekBarType.Live) {
                ...
                this.getDomElement().attr(
                  ...
                  ''
                    ...
                    .concat(
                      i18n_1.i18n.performLocalization(i18n_1.i18n.getLocalizer('seekBar.value')),
                      ': ',
                    )
                ...
                var ariaValueText = ''
                  .concat(
                    stringutils_1.StringUtils.secondsToText(this.player.getCurrentTime()),
                    ' ',
                  )
                  .concat(
                    i18n_1.i18n.performLocalization(
                  ...
                  .concat(stringutils_1.StringUtils.secondsToText(this.player.getDuration()));
                this.getDomElement().attr(
                  'aria-valuenow',
            ...
            SeekBar.prototype.configure = function (player, uimanager, configureSeek) {
              ...
              seekBarController.setSeekBarControls(this.getDomElement(), function () {
              ...
              this.onSeek.subscribe(function (sender) {
                ...
                if (
                  ...
                  suspension = player.groupPlayback.beginSuspension(
                    groupplaybackapi_1.GroupPlaybackSuspensionReason.UserIsScrubbing,
                  );
                }
            ...
            SeekBar.prototype.initializeTimelineMarkers = function (player, uimanager) {
              ...
              this.timelineMarkersHandler = new timelinemarkershandler_1.TimelineMarkersHandler(
            ...
            SeekBar.prototype.configureSmoothPlaybackPositionUpdater = function (
              player,
              uimanager,
            ) {
              var _this = this;
            ...
            SeekBar.prototype.toDomElement = function () {
              ...
              var mouseTouchUpHandler = function (e) {
                ...
                var snappedChapter =
                  ...
                  _this.timelineMarkersHandler.getMarkerAtPosition(targetPercentage);
                _this.setSeeking(false);
                seeking = false;
                // Fire seeked event
              ...
              seekBar.on('touchstart mousedown', function (e) {
                var isTouchEvent =
                  browserutils_1.BrowserUtils.isTouchSupported && _this.isTouchEvent(e);
          ...
          var SeekBarLabel = /** @class */ (function (_super) {
            ...
            function SeekBarLabel(config) {
              ...
              _this.handleSeekPreview = function (sender, args) {
                ...
                if (args.marker) {
                  var cssClasses = (args.marker.marker.cssClasses || []).map(function (cssClass) {
          ...
          var SettingsPanel = (exports.SettingsPanel = /** @class */ (function (_super) {
            ...
            SettingsPanel.prototype.getPages = function () {
              return this.config.components.filter(function (component) {
                return component instanceof settingspanelpage_1.SettingsPanelPage;
              });
            };
            ...
            SettingsPanel.prototype.updateActivePageClass = function () {
              ...
              this.getPages().forEach(function (page) {
                if (page === _this.activePage) {
                  ...
                  page
                    .getDomElement()
                    .removeClass(_this.prefixCss(SettingsPanel.CLASS_ACTIVE_PAGE));
                }
              });
            };
            ...
            SettingsPanelItem.prototype.configure = function (player, uimanager) {
              ...
              if (
                ...
                var handleConfigItemChanged = function () {
                  ...
                  if (
                    (_this.setting instanceof videoqualityselectbox_1.VideoQualitySelectBox &&
                  ...
                  if (_this.setting.itemCount() < minItemsToDisplay) {
                    ...
                    _this.setting instanceof playbackspeedselectbox_1.PlaybackSpeedSelectBox &&
        ...
        function (require, module, exports) {
          ...
          var SettingsPanelPage = (exports.SettingsPanelPage = /** @class */ (function (_super) {
            ...
            SettingsPanelPage.prototype.getItems = function () {
              return this.config.components.filter(function (component) {
                return component instanceof settingspanelitem_1.SettingsPanelItem;
              });
            };
      ...
      54: [
        ...
        { '../localization/i18n': 93, './settingspanelpagenavigatorbutton': 53 },
      ],
      55: [
        function (require, module, exports) {
          'use strict';
          ...
          var SettingsToggleButton = /** @class */ (function (_super) {
            ...
            function SettingsToggleButton(config) {
              ...
              _this
                .getDomElement()
                .attr('aria-owns', config.settingsPanel.getActivePage().getConfig().id);
              /**
            ...
            SettingsToggleButton.prototype.configure = function (player, uimanager) {
              ...
              this.onClick.subscribe(function () {
                ...
                if (!settingsPanel.isShown()) {
                  ...
                  _this.visibleSettingsPanels.slice().forEach(function (settingsPanel) {
            ...
            SubtitleOverlay.prototype.configure = function (player, uimanager) {
              ...
              uimanager.onComponentShow.subscribe(function (component) {
                if (component instanceof controlbar_1.ControlBar) {
                  _this
                    .getDomElement()
                    .addClass(_this.prefixCss(SubtitleOverlay.CLASS_CONTROLBAR_VISIBLE));
                }
              });
              uimanager.onComponentHide.subscribe(function (component) {
                if (component instanceof controlbar_1.ControlBar) {
                  _this
                    .getDomElement()
                    .removeClass(_this.prefixCss(SubtitleOverlay.CLASS_CONTROLBAR_VISIBLE));
                }
              });
            ...
            SubtitleOverlay.prototype.configureCea608Captions = function (player, uimanager) {
              ...
              var updateCEA608FontSize = function () {
                ...
                if (subtitleOverlaySizeRatio > fontGridSizeRatio) {
                  ...
                  fontSize =
                    subtitleOverlayWidth / SubtitleOverlay.CEA608_NUM_COLUMNS / fontSizeRatio;
                  fontLetterSpacing = 0;
                }
      ...
      59: [
        ...
        { '../localization/i18n': 93, '../subtitleutils': 113, './selectbox': 48 },
      ],
      60: [
        function (require, module, exports) {
          'use strict';
        ...
        function (require, module, exports) {
          ...
          var CharacterEdgeSelectBox = /** @class */ (function (_super) {
            ...
            CharacterEdgeSelectBox.prototype.configure = function (player, uimanager) {
              ...
              this.addItem(
                'raised',
                i18n_1.i18n.getLocalizer('settings.subtitles.characterEdge.raised'),
              );
              this.addItem(
                'depressed',
                i18n_1.i18n.getLocalizer('settings.subtitles.characterEdge.depressed'),
              );
              this.addItem(
                'uniform',
                i18n_1.i18n.getLocalizer('settings.subtitles.characterEdge.uniform'),
              );
              this.addItem(
                'dropshadowed',
                i18n_1.i18n.getLocalizer('settings.subtitles.characterEdge.dropshadowed'),
              );
        ...
        function (require, module, exports) {
          ...
          var FontFamilySelectBox = /** @class */ (function (_super) {
            ...
            FontFamilySelectBox.prototype.configure = function (player, uimanager) {
              ...
              this.addItem(
                'monospacedserif',
                i18n_1.i18n.getLocalizer('settings.subtitles.font.family.monospacedserif'),
              );
              this.addItem(
                'proportionalserif',
                i18n_1.i18n.getLocalizer('settings.subtitles.font.family.proportionalserif'),
              );
              this.addItem(
                'monospacedsansserif',
                i18n_1.i18n.getLocalizer('settings.subtitles.font.family.monospacedsansserif'),
              );
              this.addItem(
                'proportionalsansserif',
                i18n_1.i18n.getLocalizer('settings.subtitles.font.family.proportionalsansserif'),
              );
              this.addItem(
                'casual',
                i18n_1.i18n.getLocalizer('settings.subtitles.font.family.casual'),
              );
              this.addItem(
                'cursive',
                i18n_1.i18n.getLocalizer('settings.subtitles.font.family.cursive'),
              );
              this.addItem(
                'smallcapital',
                i18n_1.i18n.getLocalizer('settings.subtitles.font.family.smallcapital'),
              );
          ...
          var SubtitleSettingsLabel = /** @class */ (function (_super) {
            ...
            SubtitleSettingsLabel.prototype.toDomElement = function () {
              var labelElement = new dom_1.DOM('label', {
                ...
                new dom_1.DOM('span', {}).html(i18n_1.i18n.performLocalization(this.text)),
      ...
      69: [
        ...
        { '../../eventdispatcher': 88, '../../storageutils': 111, '../component': 18 },
      ],
      70: [
        function (require, module, exports) {
          'use strict';
              ...
              _this.config = _this.mergeConfig(
                config,
                {
                  components: [
                    ...
                    new settingspanelitem_1.SettingsPanelItem(
                      i18n_1.i18n.getLocalizer('settings.subtitles.font.family'),
                    ...
                    new settingspanelitem_1.SettingsPanelItem(
                      i18n_1.i18n.getLocalizer('settings.subtitles.font.opacity'),
                    ...
                    new settingspanelitem_1.SettingsPanelItem(
                      i18n_1.i18n.getLocalizer('settings.subtitles.characterEdge'),
                    ...
                    new settingspanelitem_1.SettingsPanelItem(
                      i18n_1.i18n.getLocalizer('settings.subtitles.background.color'),
                    ...
                    new settingspanelitem_1.SettingsPanelItem(
                      i18n_1.i18n.getLocalizer('settings.subtitles.background.opacity'),
                    ...
                    new settingspanelitem_1.SettingsPanelItem(
                      i18n_1.i18n.getLocalizer('settings.subtitles.window.color'),
                    ...
                    new settingspanelitem_1.SettingsPanelItem(
                      i18n_1.i18n.getLocalizer('settings.subtitles.window.opacity'),
        ...
        function (require, module, exports) {
          ...
          var TimelineMarkersHandler = /** @class */ (function () {
            ...
            TimelineMarkersHandler.prototype.configureMarkers = function () {
              ...
              this.player.on(this.player.exports.PlayerEvent.SourceLoaded, function () {
                if (_this.player.isLive()) {
                  ...
                  _this.player.on(_this.player.exports.PlayerEvent.TimeChanged, function () {
                    return _this.updateMarkers();
                  });
              ...
              this.uimanager.onRelease.subscribe(function () {
                return _this.uimanager.getConfig().events.onUpdated.unsubscribe(function () {
                  return _this.updateMarkers();
                });
              });
            ...
            TimelineMarkersHandler.prototype.updateMarkers = function () {
              ...
              this.uimanager.getConfig().metadata.markers.forEach(function (marker) {
                ...
                if (shouldRemoveMarker(markerPosition, markerDuration)) {
                  ...
                  var matchingMarker = _this.timelineMarkers.find(function (seekbarMarker) {
            ...
            TimelineMarkersHandler.prototype.getMarkerCssProperties = function (marker) {
              ...
              var positionInPx =
                (seekBarWidthPx / 100) * (marker.position < 0 ? 0 : marker.position);
              var cssProperties = {
            ...
            TimelineMarkersHandler.prototype.configureLivePausedTimeshiftUpdater = function (
              handler,
            ) {
              var _this = this;
          ...
          function getMarkerTime(marker, player, duration) {
            ...
            return (
              duration -
              (playerutils_1.PlayerUtils.getSeekableRangeRespectingLive(player).end - marker.time)
            );
          }
          function getDuration(player) {
            ...
            var _a = playerutils_1.PlayerUtils.getSeekableRangeRespectingLive(player),
              start = _a.start,
              end = _a.end;
            return end - start;
          }
          ...
          var UIContainer = (exports.UIContainer = /** @class */ (function (_super) {
            ...
            UIContainer.prototype.configureUIShowHide = function (player, uimanager) {
              ...
              this.userInteractionEvents.forEach(function (event) {
                return _this.userInteractionEventSource.on(event.name, event.handler);
              });
              uimanager.onSeek.subscribe(function () {
            ...
            UIContainer.prototype.configurePlayerStates = function (player, uimanager) {
              ...
              for (var state in playerutils_1.PlayerUtils.PlayerState) {
                if (isNaN(Number(state))) {
                  ...
                  stateClassNames[playerutils_1.PlayerUtils.PlayerState[state]] = this.prefixCss(
              ...
              var removeStates = function () {
                ...
                container.removeClass(
                  stateClassNames[playerutils_1.PlayerUtils.PlayerState.Prepared],
                );
                container.removeClass(
                ...
                container.removeClass(
                  stateClassNames[playerutils_1.PlayerUtils.PlayerState.Finished],
                );
              };
            ...
            UIContainer.prototype.release = function () {
              ...
              if (this.userInteractionEvents) {
                this.userInteractionEvents.forEach(function (event) {
                  return _this.userInteractionEventSource.off(event.name, event.handler);
                });
              }
              _super.prototype.release.call(this);
      ...
      80: [
        ...
        { '../timeout': 114, './container': 19, './volumeslider': 81, './volumetogglebutton': 82 },
      ],
      81: [
        function (require, module, exports) {
          'use strict';
          ...
          var VolumeSlider = /** @class */ (function (_super) {
            ...
            VolumeSlider.prototype.detectVolumeControlAvailability = function () {
              /*
               * "On iOS devices, the audio level is always under the userÃ¢â‚¬â„¢s physical control. The volume property is not
          ...
          var VolumeToggleButton = /** @class */ (function (_super) {
            ...
            VolumeToggleButton.prototype.configure = function (player, uimanager) {
              ...
              volumeController.onChanged.subscribe(function (_, args) {
                ...
                _this
                  .getDomElement()
                  .data(_this.prefixCss('volume-level-tens'), String(volumeLevelTens));
              });
              this.onClick.subscribe(function () {
            ...
            DOM.prototype.addClass = function (className) {
              this.forEach(function (element) {
                ...
                if (element.classList) {
                  var classNames = className.split(' ').filter(function (className) {
      ...
      93: [
          ...
          var I18n = /** @class */ (function () {
            ...
            I18n.prototype.mergeVocabulariesWithDefaultVocabularies = function (vocabularies) {
              ...
              return Object.keys(rawVocabularies).reduce(function (mergedVocabularies, language) {
                ...
                if (
                  I18n.containsLanguage(exports.defaultVocabularies, language) &&
            ...
            I18n.prototype.initializeVocabulary = function (vocabularies) {
              this.vocabulary = ['en', this.language].reduce(function (vocab, lang) {
            ...
            I18n.prototype.getLocalizer = function (key, config) {
              ...
              return function () {
                ...
                if (config != null) {
                  vocabularyString = _this.replaceVariableWithPlaceholderIfExists(
                    vocabularyString,
                    config,
                  );
                }
        ...
        { './languages/de.json': 94, './languages/en.json': 95, './languages/es.json': 96 },
      ],
      94: [
        function (require, module, exports) {
          module.exports = {
            'settings.video.quality': 'VideoqualitÃƒÂ¤t',
            'settings.audio.quality': 'AudioqualitÃƒÂ¤t',
            ...
            'settings.audio.volume': 'LautstÃƒÂ¤rke',
            ...
            'colors.red': 'rot',
            'colors.green': 'grÃƒÂ¼n',
            'colors.blue': 'blau',
            'colors.yellow': 'gelb',
            'subtitle.example': 'Beispiel Untertitel',
            'subtitle.select': 'Untertitel auswÃƒÂ¤hlen',
      ...
      96: [
        function (require, module, exports) {
          module.exports = {
            ...
            'settings.subtitles': 'SubtÃƒÂ­tulos',
            ...
            'colors.magenta': 'magenta',
            percent: '{value}%',
            'settings.subtitles.font.size': 'tamaÃƒÂ±o de Fuente',
            ...
            'ads.remainingTime': 'Este anuncio acabarÃƒÂ¡ en {remainingTime} segundos.',
            ...
            live: 'Directo',
            'subtitle.example': 'Ejemplo de SubtÃƒÂ­tulo',
            'subtitle.select': 'Seleccionar subtÃƒÂ­tulo',
            ...
            seekBar: 'LÃƒÂ­nea de Tiempo',
            'seekBar.value': 'posiciÃƒÂ³n',
            'seekBar.timeshift': 'cambio de posiciÃƒÂ³n',
              ...
              TimeShiftAvailabilityDetector.prototype.detect = function () {
                if (this.player.isLive()) {
                  ...
                  if (timeShiftAvailableNow !== this.timeShiftAvailable) {
                    this.timeShiftAvailabilityChangedEvent.dispatch(this.player, {
        ...
        function (require, module, exports) {
          ...
          var NavigationGroup = /** @class */ (function () {
            ...
            NavigationGroup.prototype.focusFirstElement = function () {
              var element = (0, gethtmlelementsfromcomponents_1.getHtmlElementsFromComponents)(
                this.components,
              )[0];
              if (element) {
            ...
            NavigationGroup.prototype.defaultNavigationHandler = function (direction) {
              var targetElement = (0, navigationalgorithm_1.getElementInDirection)(
                this.activeElement,
                (0, gethtmlelementsfromcomponents_1.getHtmlElementsFromComponents)(this.components),
                direction,
              );
              if (targetElement) {
            ...
            NavigationGroup.prototype.trackElementHover = function () {
              ...
              var removeEventListenerFunctions = (0,
                gethtmlelementsfromcomponents_1.getHtmlElementsFromComponents)(this.components).map(
                  function (htmlElem) {
      ...
      107: [
          ...
          var SeekBarHandler = /** @class */ (function () {
            ...
            SeekBarHandler.prototype.updateScrubSpeedPercentage = function () {
              ...
              this.scrubSpeedResetTimeout = window.setTimeout(function () {
                return (_this.scrubSpeedPercentage = DefaultScrubSpeedPercentage);
            ...
            SeekBarHandler.prototype.initializeOrUpdateCursorPosition = function (
              seekBarWrapper,
              direction,
            ) {
              if (this.isScrubbing) {
            ...
            SeekBarHandler.prototype.dispatchMouseMoveEvent = function (seekBar) {
              seekBar.dispatchEvent(
                new MouseEvent('mousemove', this.getCursorPositionMouseEventInit()),
              );
            };
        ...
        { './navigationalgorithm': 103, './nodeeventsubscriber': 105, './types': 110 },
      ],
      108: [
        function (require, module, exports) {
          'use strict';
          ...
          var SpatialNavigation = /** @class */ (function () {
            function SpatialNavigation(rootNavigationGroup) {
              ...
              this.onHide = function (group) {
                var groupIndex = _this.activeNavigationGroups.findIndex(function (other) {
                  return other === group;
                });
                if (groupIndex > -1) {
                  group.disable();
            ...
            SpatialNavigation.prototype.enableDefaultNavigationGroup = function () {
              ...
              var groupToEnable =
                (_a = this.navigationGroups.find(isShown)) !== null && _a !== void 0
                  ? _a
      ...
      109: [
        function (require, module, exports) {
          ...
          function isDirection(direction) {
            return (
              typeof direction === 'string' && Object.values(types_1.Direction).includes(direction)
            );
          }
              ...
              if (format.indexOf('f') > -1) {
                ...
                if (timeString.indexOf('.') > -1) {
                  return leftPadWithZeros(
                    timeString,
                    timeString.length + (leadingZeroes - timeString.indexOf('.')),
                  );
                } else {
            ...
            function SubtitleSwitchHandler(player, element, uimanager) {
              ...
              this.selectCurrentSubtitle = function () {
                ...
                _this.listElement.selectItem(
                  currentSubtitle ? currentSubtitle.id : SubtitleSwitchHandler.SUBTITLES_OFF_KEY,
                );
              };
        ...
        function (require, module, exports) {
          ...
          (function (UIFactoryCustom) {
            ...
            function makeCustomUI(player, config) {
              ...
              var subtitleListBox = new subtitlelistbox_1.SubtitleListBox();
              var subtitleListBoxSettingsPanelPage = new settingspanelpage_1.SettingsPanelPage({
                components: [new settingspanelitem_1.SettingsPanelItem(null, subtitleListBox)],
              });
              var subtitleSettingsPanel = new settingspanel_1.SettingsPanel({
              ...
              var subtitlesToggleButton = new settingstogglebutton_1.SettingsToggleButton({
                settingsPanel: subtitleSettingsPanel,
                ariaLabel: i18n_1.i18n.getLocalizer('settings.subtitles'),
                text: i18n_1.i18n.getLocalizer('settings.subtitles'),
              ...
              var recommendationOverlay = new recommendationoverlaycustom_1.RecommendationOverlay(
                {},
                player,
              );
                    ...
                    switch (_a.label) {
                      case 0:
                        ...
                        if (!(player.getVideoElement() !== document.pictureInPictureElement))
                          return [3 /*break*/, 2];
                        return [4 /*yield*/, player.getVideoElement().requestPictureInPicture()];
                      case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                      case 2:
          ...
          })((UIFactoryCustom = exports.UIFactoryCustom || (exports.UIFactoryCustom = {})));
        },
        {
          './components/adclickoverlay': 4,
          './components/admessagelabel': 5,
        ...
        function (require, module, exports) {
          ...
          var UIManager = /** @class */ (function () {
            function UIManager(player, playerUiOrUiVariants, uiconfig) {
              ...
              this.focusVisibilityTracker = new focusvisibilitytracker_1.FocusVisibilityTracker(
                'bmpui',
              );
              // Initialize the UI
            ...
            UIManager.prototype.removeTimelineMarker = function (timelineMarker) {
              if (
                arrayutils_1.ArrayUtils.remove(this.config.metadata.markers, timelineMarker) ===
                timelineMarker
              ) {
                this.config.events.onUpdated.dispatch(this);
                return true;
          ...
          function getAllPropertyNames(target) {
            var names = [];
            while (target) {
              var newNames = Object.getOwnPropertyNames(target).filter(function (name) {
